...
Router.route('/events', {name: 'listEvents'});
...
Router.onBeforeAction(requireLogin, {only: ['newUser', 'addTeam', 'announce', 'callTeam', 'updateStatus', 'eventList']});
